...
-- Nummers zijn uniek binnen een oplage; toewijzing gaat via de sequence
-- hieronder (atomair, i.p.v. tellen-en-optellen in de API).
...
-- Volgend nummer in de Atelier-oplage (atomair via de sequence)
...
-- ============================================================
-- ORDERBEHEER: tijdlijn, mail-outbox, rate limit
-- (identiek aan migrations/20260801_orderbeheer.sql)
-- ============================================================
